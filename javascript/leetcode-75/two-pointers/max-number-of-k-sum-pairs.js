...
var maxOperations = function(nums, k) {
    ...
    // instructions
    // sort numbers to make this more efficient
    // start pointers at either end
    // subtract nums value from k to find element
    // if it exists then count increases
    ...
    while (l < r) {
        ...
        // check if k - l pointer value equals r pointer value
        if (k - nums[l] === nums[r]) {
            count++
            l++
            r--
        ...
        // decrements r pointer if k - l pointer value is greater than r pointer value
        else if (k - nums[l] < nums[r]) {
            r--
        }
        
        // increments l pointer if k - l pointer value is less than r pointer value
        else {
            l++
        }
    }
